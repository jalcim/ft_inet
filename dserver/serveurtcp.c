...
/*
  protocol :login: envoi du nom d'utilisateur avant le mode
  protocol :c/x: envoi du mode, envoi du buffer
  protocol :f: envoi du mode, envoi du nom de fichier, envoi du buffer
  protocol :d: envoi du mode, (dir:) envoi du nombre de fichier, (re:)if dir ? (goto dir;) : envoi du nom de fichier, envoi du buffer(goto re;)
  protocol :signal: confirmation
*/
